...
{
    /// <inheritdoc />
    public partial class SeedBranchesAndServices : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "شارع المحكمة الرئيسي", "محكمة القاهرة" },
                    { 2, "شارع المستشفى العام", "مستشفى السلام" }
                });

            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "BranchId", "DomainType", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, 1, 1, true, "قيد دعوى" },
                    { 2, 1, 1, true, "إستخراج شهادة" },
                    { 3, 1, 1, true, "توثيق عقد" },
                    { 4, 2, 2, true, "كشف باطنة" },
                    { 5, 2, 2, true, "كشف عظام" },
                    { 6, 2, 2, true, "تحاليل طبية" }
                });
