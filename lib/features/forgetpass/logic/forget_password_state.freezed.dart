...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ForgetPasswordResponse? data)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ForgetPasswordResponse? data)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ForgetPasswordResponse? data)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Loading implements ForgetPasswordState {
  const Loading();
...
class Success implements ForgetPasswordState {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ForgetPasswordStateCopyWith<$Res> {
...
class Error implements ForgetPasswordState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $ForgetPasswordStateCopyWith<$Res> {
