...
class Success<T> implements BookingState<T> {
...
@override
String toString() {
  return 'BookingState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $BookingStateCopyWith<T, $Res> {
...
class Error<T> implements BookingState<T> {
...
@override
String toString() {
  return 'BookingState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $BookingStateCopyWith<T, $Res> {
