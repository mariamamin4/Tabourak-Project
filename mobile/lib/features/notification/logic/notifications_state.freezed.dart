...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationsState<T>);
}
...
/// @nodoc
class $NotificationsStateCopyWith<T,$Res>  {
$NotificationsStateCopyWith(NotificationsState<T> _, $Res Function(NotificationsState<T>) __);
}


/// Adds pattern-matching-related methods to [NotificationsState].
extension NotificationsStatePatterns<T> on NotificationsState<T> {
...
class _Initial<T> implements NotificationsState<T> {
  const _Initial();
...
class Loading<T> implements NotificationsState<T> {
  const Loading();
...
class Success<T> implements NotificationsState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $NotificationsStateCopyWith<T, $Res> {
...
class Error<T> implements NotificationsState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $NotificationsStateCopyWith<T, $Res> {
