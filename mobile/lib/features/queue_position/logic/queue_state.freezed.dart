...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( QueuePositionResponse data)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( QueuePositionResponse data)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( QueuePositionResponse data)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Loading implements QueueState {
  const Loading();
...
class Success implements QueueState {
  const Success(this.data);
  

 final  QueuePositionResponse data;
...
@override
String toString() {
  return 'QueueState.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $QueueStateCopyWith<$Res> {
  factory $SuccessCopyWith(Success value, $Res Function(Success) _then) = _$SuccessCopyWithImpl;
@useResult
$Res call({
 QueuePositionResponse data
});
...
class Error implements QueueState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $QueueStateCopyWith<$Res> {
